...
export interface SharepointChoiceExportOptions {
  ...
  sourceRows?:
    ...
    | ((
        context: Omit<SharepointChoiceExportContext, "sourceRows">,
      ) => SharepointChoiceRow[] | Promise<SharepointChoiceRow[]>);
  columns?:
    | SharepointChoiceExportColumn[]
    | ((
        context: SharepointChoiceExportContext,
      ) => SharepointChoiceExportColumn[] | Promise<SharepointChoiceExportColumn[]>);
  rows?:
    | Array<Record<string, any>>
    | ((context: SharepointChoiceExportContext) => Array<Record<string, any>> | Promise<Array<Record<string, any>>>);
  autoWidth?: boolean;
}
